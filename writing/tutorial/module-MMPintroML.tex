...
\includegraphics[width=\picwi]{Figures/Spectra-data/pie_boss_z0-710.jpg}
\\
\centerline{\mygray{\tiny www.sdss.org}}
\includegraphics[width=\picwi]{Figures/Spectra-data/specById_asp.png}
\end{column}
%
...
\eit
\includegraphics[width=0.6\tttwi]{Figures/Spectra-data/3D-PC-AllData/pcEmbed_SFR-trim.png}
...
\includegraphics[width=\picwi]{Figures-aspirin/renderings/aspirin.png}
\\
\includegraphics[width=\picwi]{Figures-aspirin/aspirin-R33-82.png}
\end{column}
\begin{column}{0.7\tttwi}
\bit
...
\item[]
\eit
\includegraphics[width=0.6\tttwi]{Figures-aspirin/00selected/fig-aspirin-cc.png}
\end{column}
\end{columns}
...
\item Usually, large sample size \myblue{\nsam}
\eit
\end{frame}
%------------------------------------------------------------------------
%\begin{frame}<beamer:0|handout:0>\frametitle{ When to do (non-linear) dimension reduction}
...
\hspace{-.3em}\includegraphics[width=1.\picwi]{Figures-aspirin/00selected/fig-aspirin-cc.png}
&
\includegraphics[width=1.\picwi]{Figures/Spectra-data/3D-PC-AllData/pcEmbed_SFR-trim.png}\\
\end{tabular}
\end{center}
...
\item To save space and computation
  \bit
  \item $\nsam\times \dhigh$ data matrix $\rightarrow\;n\times \dembed$, $\dembed\ll \dhigh$
      \eit
...
\begin{tabular}{cc}
points in $\dhigh\geq 3$ dimensions & same points reparametrized in 2D \\ 
